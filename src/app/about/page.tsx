...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "khoa.qianyinga@gmail",
    href: "khoa.qianyinga@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "1234567890",
    href: "tel:+84 911 555 351",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/khoa-nguyen-016280323/",
    content: "/khoa-nguyen-016280323",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/schweizerwilsemann",
    content: "/schweizerwilsemann",
...
const TOOLS = [
  ...
  },
  {
    name: "Google Play",
    content: "Next.js is a React framework for production",
    icon: <FaGooglePlay size={"50px"} color="#e0234e" />,
    color: "#e0234e",
  },
  {
    name: "Express.js",
  ...
  },
  {
    name: "Google",
    content: "Next.js is a React framework for production",
    icon: <FaGoogle size={"50px"} color="#3f51b5" />,
    color: "#000000",
  },
];
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Khoa Nguyen. I&apos;m a student at University of Transport and Communications.
              I&apos;m interested in web development, especially I am now studying frontend and backend development.
              I also like to learn about devops and cloud computing.
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me [Your
              Interests/Hobbies], exploring new technologies, or sipping milktea
